...
export const MilestoneGrid: React.FC<MilestoneGridProps> = ({
	...
	// MSRヘッダー取得フック
	const { data: MSRHeaderData } = useMSRHeader(MSRMngCode || '');

	// MSRデータ取得フック
	const { data: AIPData, refetch } = useMSRData(MSRMngCode || '');
